...
function CopyableText(props: { value: string }) {
...
export function CommitteeShareHint(props: { committeeID: CommitteeID }) {
...
export function VerboseShareCapabilities() {
  return (
    <List bulleted>
      <List.Item>Upload files</List.Item>
      <List.Item>
        Add themselves to speakers' lists that have the <i>Delegates can queue</i> flag enabled
      </List.Item>
      <List.Item>
        Add and edit amendments on resolutions that have the <i>Delegates can amend</i> flag enabled
      </List.Item>
      <List.Item>
        Propose motions that have the <i>Delegates can propose motions</i> flag enabled
      </List.Item>
      <List.Item>
        Vote on motions that have the <i>Delegates can vote on motions</i> flag enabled
      </List.Item>
      <List.Item>Vote on strawpolls</List.Item>
    </List>
  );
...
export function StrawpollShareHint(props: { committeeID: CommitteeID; strawpollID: StrawpollID }) {
  const hostname = window.location.hostname;
