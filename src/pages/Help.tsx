...
export default class Help extends React.PureComponent<{}, {}> {
  gpl = (<a href="https://github.com/MaxwellBo/Muncoordinated-2/blob/master/LICENSE">GNU GPLv3</a>);
  ...
  render() {
    ...
    return (
      <Container text style={{ padding: '1em 0em' }}>
        ...
        <Segment attached="bottom">{KEYBOARD_SHORTCUT_LIST}</Segment>
        <Header as="h3" attached="top">
          Bug reporting &amp; help requests
        </Header>
        <Segment attached="bottom">
          ...
          <List ordered>
            <List.Item>
              ...
              . You can also use this for help requests regarding the apps usage.
            </List.Item>
            <List.Item>Describe what you intended to do</List.Item>
            <List.Item>Describe what happened instead</List.Item>
            <List.Item>
        ...
        <Segment attached="bottom">Muncoordinated is licensed under {gpl}</Segment>
        <Header as="h3" attached="top">
          Social media
        </Header>
        <Segment attached="bottom">
