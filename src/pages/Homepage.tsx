...
const HomepageHeading = ({ mobile }: HomepageHeadingProps) => (
  <Container text>
    ...
    <Header
      as="h2"
      content="Moderator program customized for MMUN2023"
      inverted
      style={{
    ...
    <Button
      ...
      size="huge"
      href="/onboard"
      onClick={logClickCreateACommitteeButton}
    >
      Create a committee
            ...
            <Grid.Row>
              <Grid.Column width={8}>
                ...
                <p style={{ fontSize: "1.33em" }}>
                  ...
                  <a href="https://discord.com/">Discord</a>, which allows you
                  to speak, pass notes, &amp; share files and links.
                </p>
                <p style={{ fontSize: "1.33em" }}>
                  If you've got a big committee, multiple directors can manage
                  it at the same time, using the same account.
                </p>
                <Header as="h3" style={{ fontSize: "2em" }}>
              ...
              <Grid.Row>
                ...
                <Grid.Column width={7}>
                  ...
                  <p>
                    ...
                    by <a href="https://github.com/MaxwellBo">Max Bo</a>, with
                    assistance from the{" "}
